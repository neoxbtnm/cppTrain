//Задание 1:
//Создать окно и добиться, чтобы оно :
//- стабильно открывалось
//- не зависало
//- корректно закрывалось через кнопку
//
//Задание 2:
//Добавить в заголовок окна :
//- изменение текста в реальном времени(например, счетчик кадров)
